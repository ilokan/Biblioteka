...
<body> 
    ...
    <div class="w-screen h-96  flex flex-wrap justify-center pt-0 pb-0  bg-neutral-100">
        ...
        <div id="ispis1" class="w-64 h-96 relative align-top grid grid-cols-1 m-0 border rounded-xl bg-neutral-200">
            ...
            <h1 class="text-xl justify-self-center self-top" id="naslov1"></h1>
            <p id="autor1" class="justify-self-center self-top"></p>
            <img id="slika1" src="" alt="Slika" class="w-180 h-248" style="display:none"><button id="x1" class="absolute top-2 right-4"></button>  </div>
        <div id="ispis2" class="w-64 h-96 relative align-top  grid grid-cols-1 m-0 border rounded-xl bg-neutral-200">
            ...
            <img id="slika2" src="" alt="Slika" class="w-180 h-248 max-w-180 max-h-248" style="display:none"><button id="x2" class="absolute  top-2 right-4"></button> </div>
        <div id="ispis3" class="w-64 h-96 relative align-top  grid grid-cols-1 m-0 border rounded-xl bg-neutral-200">
            ...
            <img id="slika3" src="" alt="Slika" class="w-180 h-248" style="display:none"><button id="x3" class="absolute  top-2 right-4"></button> </div>
        <div id="ispis4" class="w-64 h-96 relative align-top  grid grid-cols-1 m-0 border rounded-xl bg-neutral-200">
            ...
            <img id="slika4" src="" alt="Slika" class="w-180 h-248" style="display:none"><button id="x4" class=" absolute  top-2 right-4"></button></div>
        <div id="ispis5" class="w-64 h-96 relative align-top  grid grid-cols-1 m-0 border rounded-xl bg-neutral-200">
            ...
            <img id="slika5" src="" alt="Slika" class="w-180 h-248" style="display:none"><button id="x5" class="absolute  top-2 right-4"></button> </div>
        </div>
        </div>
