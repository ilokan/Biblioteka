...
<body class="bg-neutral-300 grid grid-cols-1 grid-rows-4 justify-items-center"> 
    ...
    <div class="w-screen h-40 flex m-0 p-6 row-span-1 bg-neutral-400 border-4 border-neutral-500"><p>Made by me</p></div>
</body> 
</html>